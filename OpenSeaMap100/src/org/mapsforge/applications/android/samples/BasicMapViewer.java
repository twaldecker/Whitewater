...
public class BasicMapViewer extends Activity implements OnSharedPreferenceChangeListener {
	...
	protected File getMapFile() {
        File myDirPath = Environment.getExternalStorageDirectory();
        String myDirPathStr = myDirPath.getAbsolutePath();
        Log.i(SamplesApplication.TAG,myDirPathStr);
	...
	protected String getMapFileName() {
		...
		// return "germany.map";
        //
        return "tag_housenr_added_Warnemuende2014_02_07_02.map";
        //return "DE1401V2_Rostock-Bornholm.map";
	}
    ...
    protected void showParams() {
        MapView myMapView = this.mapViews.get(0);
        MapViewPosition myMapViewPosition = myMapView.getModel().mapViewPosition;
        byte myZoom = myMapViewPosition.getZoomLevel();
        LatLong myLatLong = myMapViewPosition.getCenter();

        String aTitle = (String) this.getTitle();
        this.setTitle(aTitle + "Params on startup   zoom " + myZoom + "  LAT " +  myLatLong.latitude + " LON " + myLatLong.longitude);
    }
